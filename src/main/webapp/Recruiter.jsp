...
<body>
            ...
            <div class="sidebar-logo">
                ...
                <div class="logo-header" data-background-color="dark">
                    <a href="index.html" class="logo">
                        <img src="assets/img/job-portal-logo.svg" alt="navbar brand" class="navbar-brand" height="20">
                    </a>
                ...
                <div class="sidebar-content">
                    <ul class="nav nav-secondary">
                        ...
                        <li class="nav-section">
                            ...
                            <h4 class="text-section">Recruiter Tools</h4>
                        </li>
                        <li class="nav-item">
                                ...
                                <ul class="nav nav-collapse">
                                    ...
                                    <li>
                                        <a href="managejobs.jsp">
                                            <span class="sub-item">Manage Jobs</span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse" id="applications">
                                <ul class="nav nav-collapse">
                                    ...
                                    <li>
                                        <a href="shortlist-candidates.jsp">
                                            <span class="sub-item">Shortlist Candidates</span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
                                    ...
                                    <div class="quick-actions-scroll scrollbar-outer">
                                        <div class="quick-actions-items">
                                            <div class="row m-0">
                                                ...
                                                <a class="col-6 col-md-4 p-0" href="jobpost.jsp">
                                                    <div class="quick-actions-item">
                            ...
                            <li class="nav-item topbar-user dropdown hidden-caret">
                                <a class="dropdown-toggle profile-pic" data-bs-toggle="dropdown" href="#" aria-expanded="false">
                                    ...
                                    <span class="profile-username">
                                        <span class="op-7">Hi,</span> <span class="fw-bold">Recruiter Name</span>
                                    </span>
                                </a>
                                        ...
                                        <li>
                                            <div class="user-box">
                                                ...
                                                <div class="u-text">
                                                    ...
                                                    <p class="text-muted">recruiter@example.com</p><a href="profile.jsp" class="btn btn-xs btn-secondary btn-sm">View Profile</a>
                                                </div>
                                            </div>
                                        </li>
                                        <li>
                ...
                <div class="page-inner">
                    <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
                        <div>
                            ...
                            <h6 class="op-7 mb-2">Manage your job postings and applications</h6>
                        </div>
                        <div class="ms-md-auto py-2 py-md-0">
                            <a href="jobpost.jsp" class="btn btn-primary btn-round">
                ...
                <div class="container-fluid d-flex justify-content-between">
                    <nav class="pull-left">
                        <ul class="nav">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="licenses.jsp">
                                    Licenses
                                </a>
                            </li>
                        </ul>
    ...
    <script>
        ...
        var ctx = document.getElementById("applicationTrendsChart").getContext("2d");
        new Chart(ctx, {
            type: "line",
            data: {
...
=======
>>>>>>> 38a5ee147d88cb3bd3885934574c30322617b5da
