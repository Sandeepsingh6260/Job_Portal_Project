...
<body>
				...
				<div class="sidebar-content">
					<ul class="nav nav-secondary">
						...
						<li class="nav-item"><a data-bs-toggle="collapse"
							href="#jobs"> <i class="fas fa-briefcase"></i>
								<p>Jobs</p> <span class="caret"></span>
						</a>
							<div class="collapse" id="jobs">
								<ul class="nav nav-collapse">
									<li><a href="PostJob.jsp"> <span class="sub-item">Post
												New Job</span>
									</a></li>
									<li><a href="managejobs.jsp"> <span class="sub-item">Manage
												Jobs</span>
									</a></li>
								</ul>
							</div></li>
						<li class="nav-item"><a data-bs-toggle="collapse"
							...
							<div class="collapse" id="applications">
								<ul class="nav nav-collapse">
									<li><a href="view-applications.jsp"> <span
											class="sub-item">View Applications</span>
									</a></li>
		...
		<div class="main-panel">
									...
									<div class="quick-actions-scroll scrollbar-outer">
										<div class="quick-actions-items">
											<div class="row m-0">
												...
												</a> <a class="col-6 col-md-4 p-0" href="jobpost.jsp">
													<div class="quick-actions-item">
							...
							<li class="nav-item topbar-user dropdown hidden-caret"><a
								...
								href="#" aria-expanded="false">
									<div class="avatar-sm">
										...
										<span class="fw-bold"><%=user != null ? user.getUser_name() : "Guest"%></span>
								</span>
							</a>
									...
									<div class="dropdown-user-scroll scrollbar-outer">
										<li>
											<div class="user-box">
												...
												<div class="u-text">
													<h4><%=user != null ? user.getUser_name() : "Guest"%></h4>
													<p class="text-muted"><%=user != null ? user.getUser_email() : "guest@example.com"%></p>
													<a href="profile.jsp"
										...
										<li>
											...
											href="profile.jsp">My Profile</a> <a class="dropdown-item"
											href="#">My Balance</a> <a class="dropdown-item" href="#">Inbox</a>
											<div class="dropdown-divider"></div> <a class="dropdown-item"
											href="settings.jsp">Account Setting</a>
											<div class="dropdown-divider"></div> <li><a class="dropdown-item" href="AuthenticationServlet?action=logout">Logout</a></li>
								...
								<div class="card-header">
									<div class="card-head-row">
										...
										<div class="card-tools">
											<a href="#"
												class="btn btn-label-success btn-round btn-sm me-2"> <span
												class="btn-label"> <i class="fa fa-pencil"></i>
											</span> Export
											</a> <a href="#" class="btn btn-label-info btn-round btn-sm">
						...
						<div class="col-md-4">
							<div class="card card-primary card-round">
										...
										<div class="card-tools">
											<div class="dropdown">
												<button class="btn btn-sm btn-label-light dropdown-toggle"
													...
													aria-expanded="false">View All</button>
								...
								<div class="card-body pb-0">
									...
									<div class="pull-in">
										<canvas id="recentApplicationsChart"></canvas>
									</div>
								</div>
							</div>
							<div class="card card-round">
								<div class="card-body pb-0">
									...
									<h2 class="mb-2">Hire Rate</h2>
									<p class="text-muted">This Month</p>
									<div class="pull-in sparkline-fix">
										<div id="hireRateChart"></div>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="card card-round">
								<div class="card-header">
									<div class="card-head-row card-tools-still-right">
										<h4 class="card-title">Candidate Distribution</h4>
										<div class="card-tools">
									...
									<p class="card-category">Map of candidate locations</p>
								</div>
								<div class="card-body">
									<div class="row">
										<div class="col-md-6">
												...
												<table class="table">
													<tbody>
														...
														<tr>
															<td>
																<div class="flag">
																	<img src="assets/img/flags/de.png" alt="germany">
																</div>
															</td>
															<td>Germany</td>
														...
														<tr>
															<td>
																<div class="flag">
																	<img src="assets/img/flags/gb.png" alt="united kingdom">
																</div>
															</td>
														...
														<tr>
															<td>
																<div class="flag">
																	<img src="assets/img/flags/ro.png" alt="romania">
																</div>
															</td>
															<td>Romania</td>
														...
														<tr>
															<td>
																<div class="flag">
																	<img src="assets/img/flags/br.png" alt="brasil">
																</div>
															</td>
															<td>Brasil</td>
			...
			<footer class="footer">
				<div class="container-fluid d-flex justify-content-between">
					<nav class="pull-left">
						<ul class="nav">
							<li class="nav-item"><a class="nav-link" href="help.jsp">
									Help </a></li>
							<li class="nav-item"><a class="nav-link" href="licenses.jsp">
									Licenses </a></li>
						</ul>
					</nav>
					<div class="copyright">
						2024, made with <i class="fa fa-heart heart text-danger"></i> by <a
							href="#">Job Portal Team</a>
					</div>
				</div>
			</footer>
		</div>
	...
	<script>
		...
		// Other charts can be added similarly
	</script>
</body>
</html>
