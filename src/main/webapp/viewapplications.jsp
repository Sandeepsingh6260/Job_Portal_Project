								...
								<div class="action-buttons">
									...
									<%-- <form action="./RecruiterServlet" method="post"
										...
										<input type="hidden" name="applicationId"
											value="<%=app.getId()%>">
										<button class="btn btn-shortlist" type="submit">
									...
									<form action="./RecruiterServlet" method="post"
										style="display: inline;">
										<input type="hidden" name="action" value="REJECTED"> <input
											type="hidden" name="applicationId" value="<%=app.getId()%>">
										...
										<a
											...
											class="btn btn-reject"> <i class="fas fa-times"></i>
											Reject
										</a>
								</div>
							</td>
					...
					<div class="detail-section">
						...
						<div class="detail-item">
							<span class="detail-label">Resume:</span> <span
								class="detail-value"> <%
 if (app.getResumeLink() != null && !app.getResumeLink().trim().isEmpty()) {
 %>
								<a href="downloadResume?file=<%=app.getResumeLink()%>"
								class="resume-link" target="_blank"> <i
									class="fas fa-download"></i> Download Resume
							</a> <%
 } else {
 %> No resume uploaded <%
 }
